...
public class LanguageManager {
    ...
    public enum Strings {OPTION, ONLINE, BUSY, REQUESTED, TOACCEPT, TODECLINE, CANCELLED, CONFIRMED, NOTYOURS, NOROOM, FINISHED, SURE, SENT, TIMED, DECLINED, YOURSELF, NOTNOW, IGNORING, NOTIGNORING, UNABLE, PLAYERIGNORING, CREATIVE, TOOFAR, DUPE}
